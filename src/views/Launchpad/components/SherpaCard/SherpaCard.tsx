      ...
      <CardContent>
        <Flex alignItems='center' mb='24px'>
          ...
          <div>
            ...
            <Details>
              <Text fontSize='12px' onClick={handleViewHomePage}>Homepage</Text>
              <Text fontSize='12px' onClick={handleViewDocumentation}>Documentation</Text>
              <Text fontSize='12px' onClick={handleViewMedium}>Medium</Text>
            </Details>
          </div>
        </Flex>
        ...
        <ClaimsWrapper>
          ...
          <div className='claim-container'>
            ...
            <ClaimButton disabled height='32px' size='sm'>Claim</ClaimButton>
          </div>
        </ClaimsWrapper>
      </CardContent>
      <CardAction>
