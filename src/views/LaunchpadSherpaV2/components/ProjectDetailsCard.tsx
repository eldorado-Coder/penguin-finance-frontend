    ...
    return (
      <AllocationsContainer>
        ...
        <TierInfo justifyContent='space-between' alignItems='center'>
          <Allocation src={`${process.env.PUBLIC_URL}/images/ido/tiers/${yourTier}.png`} alt='allocation' />
          <AllocationInfo>
            <Flex>
  ...
  const renderAbout = () => {
    return (
      <IdoDetails>
        ...
        <HeaderTitle fontSize='34px' color='#313131' fontWeight={800} mt='50px' mb='8px'>About the Sherpa Project</HeaderTitle>
