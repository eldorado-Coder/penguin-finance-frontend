...
export const config: MenuEntry[] = [
  ...
  },
  {
    ...
    items: [
      {
        label: 'Trader Joe',
        href: 'https://www.traderjoexyz.com/#/trade?outputCurrency=0xe896CDeaAC9615145c0cA09C8Cd5C25bced6384c',
      },
      {
  ...
  },
  {
    ...
    items: [
      {
        label: 'English',
        href: 'docs.penguinfinance.io/',
      },
      {
        label: 'Türkçe',
        href: 'https://penguinfinance.gitbook.io/penguin-finance-tuerkce/',
      },
      {
        label: 'Français',
